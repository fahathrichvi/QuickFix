...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 font-sans">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-28 border-b border-slate-800 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-950/40 via-slate-950 to-slate-950">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-flex items-center space-x-2 rounded-full bg-blue-500/10 border border-blue-500/20 px-3 py-1 text-xs font-semibold text-blue-400 mb-6">
          ...
          <form action="/search" method="GET" className="mt-10 max-w-3xl mx-auto">
            <div className="flex flex-col sm:flex-row items-center bg-slate-900/90 border border-slate-700/80 rounded-2xl p-2 shadow-2xl shadow-blue-950/50 backdrop-blur-md gap-2">
              <div className="flex items-center flex-1 px-3 w-full">
                ...
                <input
                  ...
                  className="w-full bg-transparent border-0 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-0 px-3 py-2 text-sm"
                />
              </div>

              <div className="flex items-center px-3 border-t sm:border-t-0 sm:border-l border-slate-800 w-full sm:w-auto">
                ...
                <input
                  ...
                  className="w-full sm:w-36 bg-transparent border-0 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-0 px-2 py-2 text-sm"
                />
              </div>
            ...
            {categories?.map((cat: any) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-center space-x-2 bg-slate-900/60 hover:bg-slate-800 border border-slate-800 hover:border-blue-500/40 px-4 py-2 rounded-xl text-xs font-medium text-slate-300 hover:text-white transition group"
                >
                  <IconComp className="h-3.5 w-3.5 text-blue-400 group-hover:scale-110 transition-transform" />
                  <span>{cat.name}</span>
                </Link>
              );
            })}
      ...
      <section className="py-16 bg-slate-950">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
            <div>
              <div className="text-xs font-semibold uppercase tracking-wider text-blue-400 mb-2">Verified Professionals</div>
              <h2 className="text-2xl sm:text-3xl font-bold text-white">Top Rated Local Businesses</h2>
            </div>
            <Link
              href="/search"
              className="mt-4 md:mt-0 text-sm font-medium text-blue-400 hover:text-blue-300 flex items-center space-x-1"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredBusinesses?.map((biz: any) => (
              <div
                key={biz.id}
                className="bg-slate-900 border border-slate-800 hover:border-slate-700 rounded-2xl overflow-hidden transition shadow-lg hover:shadow-2xl hover:shadow-blue-950/30 group flex flex-col justify-between"
              >
                <div>
                  <div className="relative h-48 bg-slate-800 overflow-hidden">
                    ...
                    {biz.verification_status === 'approved' && (
                      <div className="absolute top-3 right-3 bg-emerald-500/20 backdrop-blur-md border border-emerald-500/40 text-emerald-300 text-xs font-medium px-2.5 py-1 rounded-full flex items-center space-x-1">
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4 flex items-center justify-between text-xs text-slate-300">
                      <div className="flex items-center space-x-1 bg-amber-500/10 text-amber-300 px-2 py-1 rounded-md border border-amber-500/20">
                ...
                <div className="p-5 pt-0 border-t border-slate-800/60 mt-4 flex items-center justify-between">
                  <span className="text-xs text-slate-400">Instant booking available</span>
                  <Link
      ...
      <section className="py-16 border-t border-b border-slate-800 bg-slate-900/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Engineered for Speed & Reliability</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
              ...
              <h3 className="text-lg font-bold text-white mb-2">PostGIS Radius Search</h3>
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Atomic Double-Booking Protection</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Supabase Realtime Updates</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <section className="py-16 bg-gradient-to-b from-slate-950 via-blue-950/20 to-slate-950">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-blue-900/60 to-indigo-900/60 border border-blue-500/30 rounded-3xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-2xl">
              <h2 className="text-2xl sm:text-4xl font-bold text-white">Are you a Local Business Owner?</h2>
