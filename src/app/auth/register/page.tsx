  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 max-w-md w-full shadow-2xl space-y-6">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold text-white">Join Quickfix</h1>
        <p className="text-xs text-slate-400 mt-1">Create your marketplace account in seconds.</p>
      </div>
      ...
      <form onSubmit={handleRegister} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2.5 text-xs text-white focus:outline-none focus:border-blue-500 appearance-none cursor-pointer pr-10"
              required
            >
              {cities.map((c) => (
        ...
        {role === 'business_owner' && (
          <>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1">Marketplace Category</label>
              <div className="relative">
                <select
                  value={categoryId}
                ...
                <Tag className="absolute right-3 top-3 h-4 w-4 text-slate-400 pointer-events-none" />
              </div>
            </div>
          </>
        )}
